...
const CreatePodcast = () => {
  const [imagePropmpt, setImagePropmpt] = useState('');
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="mt-12 flex w-full flex-col">
          <div className="flex flex-col gap-[30px] border-b border-black-5 pb-10">
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-col gap-2.5">
                  ...
                  <FormControl>
                    <Input className="input-class focus-visible:ring-offset-orange-1" placeholder="Eco Podcast" {...field} />
                  </FormControl>
            ...
            <div className="flex flex-col gap-2.5">
              ...
              <Select onValueChange={(value) => setVoiceType(value)}>
                <SelectTrigger className={cn('text-16 w-full border-none text-gray-1 focus-visible:ring-offset-orange-1')}>
          ...
          <div className="flex flex-col pt-10">
            ...
            <div className="mt-10 w-full border border-orange-1">
