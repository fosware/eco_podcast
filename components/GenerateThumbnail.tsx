    ...
    <>
      ...
      {isAiThumbnail ? (
        <div className="flex flex-col gap-5">
          ...
          <div className="mw-full max-w-[200px]">
            <Button type="submit" className="text-16 bg-orange-1 py-4 font-bold
              text-white-1" onClick={generateImage}>
              {isImageLoading ? (
                <>
                  Generating
        ...
        <div className="image_div" onClick={() => imageRef?.current?.click()}>
          ...
          <div className="flex flex-col items-center gap-1">
            ...
            >SVG, PNG, JPG or GIF (max. 1080x1080)</p>
          </div>
        </div>
      )}
      {image && (
